...
!(function (t, e) {
				...
				: 'string' === e &&
				  ...
				  '#' === s[0] &&
						(4 === o || 5 === o
							...
							: (7 !== o && 9 !== o) ||
							  (n = { r: (St[s[1]] << 4) | St[s[2]], g: (St[s[3]] << 4) | St[s[4]], b: (St[s[5]] << 4) | St[s[6]], a: 9 === o ? (St[s[7]] << 4) | St[s[8]] : 255 })),
				  (i = n || jt(t) || Gt(t))),
				(this._rgb = i),
				(this._valid = !!i);
		}
	...
	function ve(t, e) {
		...
		return (
			o && ((f -= a.width + r.width), (g -= a.height + r.height)), { x: Math.round((((l - d) / f) * i.width) / s), y: Math.round((((h - u) / g) * i.height) / s) }
		);
	}
	...
	function Pi(t, e, i, s) {
		...
		for (o = 0, a = t.length; o < a; ++o)
			if (
				((r = t[o]),
				void 0 !== r && (void 0 !== e && 'function' == typeof r && ((r = r(e)), (l = !1)), void 0 !== i && n(r) && ((r = r[i % r.length]), (l = !1)), void 0 !== r))
			)
	...
	function zi(t, e) {
		...
		return Fi(
			...
			(function (t, e, i, s) {
				...
				for (a = e + 1; a <= i; ++a) {
					const i = t[a % n];
					i.skip || i.stop ? l.skip || ((s = !1), o.push({ start: e % n, end: (a - 1) % n, loop: s }), (e = r = i.stop ? a : null)) : ((r = a), l.skip && (e = a)),
						(l = i);
				}
		...
		_update(t) {
			...
			this.update(t || 'default'),
				(e._clip = (function (t) {
					let e, i, s, n;
					return (
						o(t) ? ((e = t.top), (i = t.right), (s = t.bottom), (n = t.left)) : (e = i = s = n = t), { top: e, right: i, bottom: s, left: n, disabled: !1 === t }
					);
				})(
					l(
						this.options.clip,
	...
	function ln(t, ...e) {
		...
		for (const s of e) {
			const e =
				s.axis || ('top' === (i = s.position) || 'bottom' === i ? 'x' : 'left' === i || 'right' === i ? 'y' : void 0) || (t.length > 1 && rn(t[0].toLowerCase()));
			if (e) return e;
		}
		var i;
						...
						l =
							'flex' === n.barThickness
								...
								: (function (t, e, i, n) {
										...
										let a, r;
										return (
											s(o) ? ((a = e.min * i.categoryPercentage), (r = i.barPercentage)) : ((a = o * n), (r = 1)), { chunk: a / n, ratio: r, start: e.pixels[t] - a / 2 }
										);
								  })(t, e, n, i),
			...
			return (function (t) {
				const { scale: e = {}, fill: i } = t,
					s = (function (t, e) {
						let i = null;
						return (
							'start' === t ? (i = e.bottom) : 'end' === t ? (i = e.top) : o(t) ? (i = e.getPixelForValue(t.value)) : e.getBasePixel && (i = e.getBasePixel()), i
						);
					})(i, e);
				if (a(s)) {
	...
	function da(t, e, i) {
		...
		s &&
			...
			(function (t, e) {
				...
				t.save(),
					'x' === l && o !== n && (ua(t, s, a.top), fa(t, { line: i, target: s, color: n, scale: r, property: l }), t.restore(), t.save(), ua(t, s, a.bottom));
			...
			for (a = 0; a < s; ++a)
				(o = t.getDatasetMeta(a)),
					...
					r &&
						r.options &&
						r instanceof no &&
						(l = { visible: t.isDatasetVisible(a), index: a, fill: aa(r, a, s), chart: t, axis: o.controller.options.indexAxis, scale: o.vScale, line: r }),
					(o.$filler = l),
					n.push(l);
